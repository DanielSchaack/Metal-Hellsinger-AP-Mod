...
namespace Randomizer
{
    public class Lookup
    {
        ...
        public static readonly Dictionary<string, string> HellsNameToAspect = new Dictionary<string, string>()
        {
            { "Voke", "Aspect of Anger" },
            { "Stygia", "Aspect of the Charged" },
            { "Yhelm", "Aspect of the Fortress" },
            { "Incaustis", "Aspect of Infernal Fury" },
            { "Gehenna", "Aspect of the Hellstorm" },
            { "Nihil", "Aspect of the Doppelganger" },
            { "Acheron", "Aspect of the Wheel" },
        };
        ...
        public static string EnemyClassToEnemyName(EnemyClassType enemyClass) =>
            enemyClass switch
            {
                EnemyClassType.Marionette => "Marionette",
                EnemyClassType.Cambion => "Cambion",
                EnemyClassType.Stalker => "Stalker",
                EnemyClassType.Reaver => "Behemoth",
                EnemyClassType.LesserSeraph => "Lesser Seraph",
                EnemyClassType.Eyeless => "Eyeless",
                EnemyClassType.Hierophant => "Hierophant",
                EnemyClassType.Elite_Cambion => "Shield Cambion",
                EnemyClassType.Elite_Stalker => "Void Stalker",
                EnemyClassType.Elite_Reaver => "Siege Behemoth",
                EnemyClassType.Elite_Seraph => "Annihilator Seraph",
                EnemyClassType.LostUnknown => "The Lost Unknown: Leviathan",
                EnemyClassType.Boss_Voke => "Anger Aspect: Voke",
                EnemyClassType.Boss_Stygia => "Charged Aspect: Stygia",
                EnemyClassType.Boss_Yhelm => "Fortress Aspect: Yhelm",
                EnemyClassType.Boss_Incaustis => "Infernal Fury Aspect: Incaustis",
                EnemyClassType.Boss_Gehenna => "Hellstorm Aspect: Gehenna",
                EnemyClassType.Boss_Nihil => "Doppelganger Aspect: Nihil",
                EnemyClassType.Boss_Acheron => "Wheel Aspect: Acheron",
                EnemyClassType.Boss_Sheol => "Red Judge - Worldbreaker: Sheol",
                _ => string.Empty,
            };

        public static string BossTypeToEnemyName(BossType bossType) =>
            bossType switch
            {
                BossType.Voke => "Anger Aspect: Voke",
                BossType.Stygia => "Charged Aspect: Stygia",
                BossType.Yhelm => "Fortress Aspect: Yhelm",
                BossType.Incaustis => "Infernal Fury Aspect: Incaustis",
                BossType.Gehenna => "Hellstorm Aspect: Gehenna",
                BossType.Nihil => "Doppelganger Aspect: Nihil",
                BossType.Acheron => "Wheel Aspect: Acheron",
                BossType.Titan => "Red Judge - Worldbreaker: Sheol",
                _ => string.Empty,
            };
        ...
        >()
        {
            { "Collectible_Voke_Easy", "Voke Coat of Arms Lamb" },
            { "Collectible_Voke_Medium", "Voke Coat of Arms Goat" },
            { "Collectible_Voke_Hard", "Voke Coat of Arms Beast" },
            { "Collectible_Voke_VeryHard", "Voke Coat of Arms Archdevil" },
            { "Collectible_Stygia_Easy", "Stygia Coat of Arms Lamb" },
            { "Collectible_Stygia_Medium", "Stygia Coat of Arms Goat" },
            { "Collectible_Stygia_Hard", "Stygia Coat of Arms Beast" },
            { "Collectible_Stygia_VeryHard", "Stygia Coat of Arms Archdevil" },
            { "Collectible_Yhelm_Easy", "Yhelm Coat of Arms Lamb" },
            { "Collectible_Yhelm_Medium", "Yhelm Coat of Arms Goat" },
            { "Collectible_Yhelm_Hard", "Yhelm Coat of Arms Beast" },
            { "Collectible_Yhelm_VeryHard", "Yhelm Coat of Arms Archdevil" },
            { "Collectible_Gehenna_Easy", "Gehenna Coat of Arms Lamb" },
            { "Collectible_Gehenna_Medium", "Gehenna Coat of Arms Goat" },
            { "Collectible_Gehenna_Hard", "Gehenna Coat of Arms Beast" },
            { "Collectible_Gehenna_VeryHard", "Gehenna Coat of Arms Archdevil" },
            { "Collectible_Incaustis_Easy", "Incaustis Coat of Arms Lamb" },
            { "Collectible_Incaustis_Medium", "Incaustis Coat of Arms Goat" },
            { "Collectible_Incaustis_Hard", "Incaustis Coat of Arms Beast" },
            { "Collectible_Incaustis_VeryHard", "Incaustis Coat of Arms Archdevil" },
            { "Collectible_Nihil_Easy", "Nihil Coat of Arms Lamb" },
            { "Collectible_Nihil_Medium", "Nihil Coat of Arms Goat" },
            { "Collectible_Nihil_Hard", "Nihil Coat of Arms Beast" },
            { "Collectible_Nihil_VeryHard", "Nihil Coat of Arms Archdevil" },
            { "Collectible_Acheron_Easy", "Acheron Coat of Arms Lamb" },
            { "Collectible_Acheron_Medium", "Acheron Coat of Arms Goat" },
            { "Collectible_Acheron_Hard", "Acheron Coat of Arms Beast" },
            { "Collectible_Acheron_VeryHard", "Acheron Coat of Arms Archdevil" },
            { "Collectible_Sheol_Easy", "Sheol Coat of Arms Lamb" },
            { "Collectible_Sheol_Medium", "Sheol Coat of Arms Goat" },
            { "Collectible_Sheol_Hard", "Sheol Coat of Arms Beast" },
            { "Collectible_Sheol_VeryHard", "Sheol Coat of Arms Archdevil" },
        };
        ...
        >()
        {
            { "WI_Marionette", "Bestiary Entry - Marionette" },
            { "WI_Cambion", "Bestiary Entry - Cambion" },
            { "WI_Reaver", "Bestiary Entry - Behemoth" },
            { "WI_Stalker", "Bestiary Entry - Stalker" },
            { "WI_Eyeless", "Bestiary Entry - Eyeless" },
            { "WI_Hierophant", "Bestiary Entry - Hierophant" },
            { "WI_LesserSeraph", "Bestiary Entry - Lesser Seraph" },
            { "WI_Elite_Cambion", "Bestiary Entry - Shield Cambion" },
            { "WI_Elite_Reaver", "Bestiary Entry - Siege Behemoth" },
            { "WI_Elite_Stalker", "Bestiary Entry - Void Stalker" },
            { "WI_Elite_LesserSeraph", "Bestiary Entry - Annihilator Seraph" },
            { "WI_Boss_Voke", "Bestiary Entry - Anger Aspect: Voke" },
            { "WI_Boss_Stygia", "Bestiary Entry - Charged Aspect: Stygia" },
            { "WI_Boss_Yhelm", "Bestiary Entry - Fortress Aspect: Yhelm" },
            { "WI_Boss_Incaustis", "Bestiary Entry - Infernal Fury Aspect: Incaustis" },
            { "WI_Boss_Gehenna", "Bestiary Entry - Hellstorm Aspect: Gehenna" },
            { "WI_Boss_Nihil", "Bestiary Entry - Doppelganger Aspect: Nihil" },
            { "WI_Boss_Acheron", "Bestiary Entry - Wheel Aspect: Acheron" },
            { "WI_Boss_Sheol", "Bestiary Entry - Red Judge - Worldbreaker: Sheol" },
            { "WI_LostUnknown", "Bestiary Entry - The Lost Unknown: Leviathan" },
        };
        ...
        public static readonly List<string> CoatOfArmsLocationIds = [
