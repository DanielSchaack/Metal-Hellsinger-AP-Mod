...
namespace Randomizer
{
    ...
    public class Items
    {
        ...
        public static readonly Dictionary<long, ItemData> ItemDataById = new Dictionary<long, ItemData>()
        {
            ...
            { 3, new ItemData(3, "Enduring Fury", progression, HELL, Ability, 1) },
            { 4, new ItemData(4, "Faster Ultimate Gain", progression, HELL, Ability, 1) },
            { 5, new ItemData(5, "Deadlier Dash", progression, HELL, Ability, 1) },
            { 6, new ItemData(6, "Explosive Slaughter", progression, HELL, Ability, 1) },
            ...
            { 50, new ItemData(50, "Progressive Hells", progression, HELL, Level, 8) },
            { 51, new ItemData(51, "Voke", progression, HELL, Level, 1) },
            { 52, new ItemData(52, "Stygia", progression, HELL, Level, 1) },
            { 53, new ItemData(53, "Yhelm", progression, HELL, Level, 1) },
            { 54, new ItemData(54, "Incaustis", progression, HELL, Level, 1) },
            { 55, new ItemData(55, "Gehenna", progression, HELL, Level, 1) },
            { 56, new ItemData(56, "Nihil", progression, HELL, Level, 1) },
            { 57, new ItemData(57, "Acheron", progression, HELL, Level, 1) },
            { 58, new ItemData(58, "Sheol", progression, HELL, Level, 1) },
            { 59, new ItemData(59, "Tutorial", progression, HELL, Level, 1) },
            { 60, new ItemData(60, "Coat of Arms", progression, HELL, Collectible, 32) },

            { 62, new ItemData(62, "Garden of Chronos", progression, LEVIATHAN, Level, 1) },
            { 63, new ItemData(63, "Calamity", progression, LEVIATHAN, Level, 1) },
            { 64, new ItemData(64, "Demonitorium", progression, LEVIATHAN, Level, 1) },
            { 65, new ItemData(65, "Tombs of the Ancients", progression, LEVIATHAN, Level, 1) },
            { 66, new ItemData(66, "Necropolis", progression, LEVIATHAN, Level, 1) },
            { 67, new ItemData(67, "Axiom", progression, LEVIATHAN, Level, 1) },
            { 68, new ItemData(68, "Final Destination", progression, LEVIATHAN, Level, 1) },

            { 70, new ItemData(70, "Progressive Tutorial Anguish Gate Skip", useful, HELL, AnguishGate, 4) },
            { 71, new ItemData(71, "Tutorial Anguish Gate 1 Skip", useful, HELL, AnguishGate, 1) },

            { 72, new ItemData(72, "Progressive Voke Anguish Gate Skip", useful, HELL, AnguishGate, 4) },
            { 73, new ItemData(73, "Voke Anguish Gate 1 Skip", useful, HELL, AnguishGate, 1) },
            { 74, new ItemData(74, "Voke Anguish Gate 2 Skip", useful, HELL, AnguishGate, 1) },
            { 75, new ItemData(75, "Voke Anguish Gate 3 Skip", useful, HELL, AnguishGate, 1) },
            { 76, new ItemData(76, "Voke Anguish Gate 4 Skip", useful, HELL, AnguishGate, 1) },

            { 77, new ItemData(77, "Progressive Stygia Anguish Gate Skip", useful, HELL, AnguishGate, 4) },
            { 78, new ItemData(78, "Stygia Anguish Gate 1 Skip", useful, HELL, AnguishGate, 1) },
            { 79, new ItemData(79, "Stygia Anguish Gate 2 Skip", useful, HELL, AnguishGate, 1) },
            { 80, new ItemData(80, "Stygia Anguish Gate 3 Skip", useful, HELL, AnguishGate, 1) },
            { 81, new ItemData(81, "Stygia Anguish Gate 4 Skip", useful, HELL, AnguishGate, 1) },

            { 82, new ItemData(82, "Progressive Yhelm Anguish Gate Skip", useful, HELL, AnguishGate, 4) },
            { 83, new ItemData(83, "Yhelm Anguish Gate 1 Skip", useful, HELL, AnguishGate, 1) },
            { 84, new ItemData(84, "Yhelm Anguish Gate 2 Skip", useful, HELL, AnguishGate, 1) },
            { 85, new ItemData(85, "Yhelm Anguish Gate 3 Skip", useful, HELL, AnguishGate, 1) },
            { 86, new ItemData(86, "Yhelm Anguish Gate 4 Skip", useful, HELL, AnguishGate, 1) },

            { 87, new ItemData(87, "Progressive Incaustis Anguish Gate Skip", useful, HELL, AnguishGate, 4) },
            { 88, new ItemData(88, "Incaustis Anguish Gate 1 Skip", useful, HELL, AnguishGate, 1) },
            { 89, new ItemData(89, "Incaustis Anguish Gate 2 Skip", useful, HELL, AnguishGate, 1) },
            { 90, new ItemData(90, "Incaustis Anguish Gate 3 Skip", useful, HELL, AnguishGate, 1) },
            { 91, new ItemData(91, "Incaustis Anguish Gate 4 Skip", useful, HELL, AnguishGate, 1) },

            { 92, new ItemData(92, "Progressive Gehenna Anguish Gate Skip", useful, HELL, AnguishGate, 4) },
            { 93, new ItemData(93, "Gehenna Anguish Gate 1 Skip", useful, HELL, AnguishGate, 1) },
            { 94, new ItemData(94, "Gehenna Anguish Gate 2 Skip", useful, HELL, AnguishGate, 1) },
            { 95, new ItemData(95, "Gehenna Anguish Gate 3 Skip", useful, HELL, AnguishGate, 1) },
            { 96, new ItemData(96, "Gehenna Anguish Gate 4 Skip", useful, HELL, AnguishGate, 1) },

            { 97, new ItemData(97, "Progressive Nihil Anguish Gate Skip", useful, HELL, AnguishGate, 4) },
            { 98, new ItemData(98, "Nihil Anguish Gate 1 Skip", useful, HELL, AnguishGate, 1) },
            { 99, new ItemData(99, "Nihil Anguish Gate 2 Skip", useful, HELL, AnguishGate, 1) },
            { 100, new ItemData(100, "Nihil Anguish Gate 3 Skip", useful, HELL, AnguishGate, 1) },
            { 101, new ItemData(101, "Nihil Anguish Gate 4 Skip", useful, HELL, AnguishGate, 1) },

            { 102, new ItemData(102, "Progressive Acheron Anguish Gate Skip", useful, HELL, AnguishGate, 4) },
            { 103, new ItemData(103, "Acheron Anguish Gate 1 Skip", useful, HELL, AnguishGate, 1) },
            { 104, new ItemData(104, "Acheron Anguish Gate 2 Skip", useful, HELL, AnguishGate, 1) },
            { 105, new ItemData(105, "Acheron Anguish Gate 3 Skip", useful, HELL, AnguishGate, 1) },
            { 106, new ItemData(106, "Acheron Anguish Gate 4 Skip", useful, HELL, AnguishGate, 1) },

            { 107, new ItemData(107, "Progressive Sheol Anguish Gate Skip", useful, HELL, AnguishGate, 4) },
            { 108, new ItemData(108, "Sheol Anguish Gate 1 Skip", useful, HELL, AnguishGate, 1) },
            { 109, new ItemData(109, "Sheol Anguish Gate 2 Skip", useful, HELL, AnguishGate, 1) },
            { 110, new ItemData(110, "Sheol Anguish Gate 3 Skip", useful, HELL, AnguishGate, 1) },
            { 111, new ItemData(111, "Sheol Anguish Gate 4 Skip", useful, HELL, AnguishGate, 1) },
            ...
            { 167, new ItemData(167, "Progressive Reload", progression, HELL, Ability, 2) },
            ...
            { 524, new ItemData(524, "Departure to Destruction", progression, ALL, Dusk, Song, 1) },
            { 525, new ItemData(525, "Hand Cannon", progression, ALL, Dusk, Song, 1) },
            { 526, new ItemData(526, "Burn in Hell", progression, ALL, Dusk, Song, 1) },
            { 527, new ItemData(527, "Murder Machine Inc", progression, ALL, Dusk, Song, 1) },
            { 528, new ItemData(528, "Endless", progression, ALL, Dusk, Song, 1) },
            { 529, new ItemData(529, "Mine Control", progression, ALL, Dusk, Song, 1) },
            { 530, new ItemData(530, "Sacrifice", progression, ALL, Dusk, Song, 1) },
            { 531, new ItemData(531, "Erebus Reaction", progression, ALL, Dusk, Song, 1) },
            { 532, new ItemData(532, "Bleeding Out", progression, ALL, Dusk, Song, 1) },
            ...
            { 538, new ItemData(538, "Down With the Sickness", progression, ALL, EssentialHits, Song, 1) },
            { 539, new ItemData(539, "Uprising", progression, ALL, EssentialHits, Song, 1) },
            { 540, new ItemData(540, "Misery Business", progression, ALL, EssentialHits, Song, 1) },
            { 541, new ItemData(541, "Tsunami (Original Mix)", progression, ALL, EssentialHits, Song, 1) },
            { 542, new ItemData(542, "Runaway (U&I)", progression, ALL, EssentialHits, Song, 1) },
            { 543, new ItemData(543, "Feel Good Inc.", progression, ALL, EssentialHits, Song, 1) },
            { 544, new ItemData(544, "I Love It feat. Charli XCX", progression, ALL, EssentialHits, Song, 1) },
            { 545, new ItemData(545, "Personal Jesus", progression, ALL, EssentialHits, Song, 1) },
            ...
            { 553, new ItemData(553, "Compliment", filler, ALL, Combat, 0) },
