...
namespace Randomizer
{
    ...
    public class Items
    {
        ...
        public static readonly Dictionary<long, ItemData> ItemDataById = new Dictionary<long, ItemData>()
        {
            ...
            { 7, new ItemData(7, "Lamb", progression, HELL, Difficulty, 1) },
            { 8, new ItemData(8, "Goat", progression, HELL, Difficulty, 1) },
            { 9, new ItemData(9, "Beast", progression, HELL, Difficulty, 1) },
            { 10, new ItemData(10, "Archdevil", progression, HELL, Difficulty, 1) },

            { 11, new ItemData(11, "Progressive Killing With Rhythm", progression, HELL, Torment, 3) },
            { 12, new ItemData(12, "Killing With Rhythm 1", progression, HELL, Torment, 1) },
            { 13, new ItemData(13, "Killing With Rhythm 2", progression, HELL, Torment, 1) },
            { 14, new ItemData(14, "Killing With Rhythm 3", progression, HELL, Torment, 1) },

            { 15, new ItemData(15, "Progressive Weapon Trickery", progression, HELL, Torment, 3) },
            { 16, new ItemData(16, "Weapon Trickery: 1", progression, HELL, Torment, 1) },
            { 17, new ItemData(17, "Weapon Trickery: 2", progression, HELL, Torment, 1) },
            { 18, new ItemData(18, "Weapon Trickery: 3", progression, HELL, Torment, 1) },

            { 19, new ItemData(19, "Progressive Relic Thief", progression, HELL, Torment, 3) },
            { 20, new ItemData(20, "Relic Thief: 1", progression, HELL, Torment, 1) },
            { 21, new ItemData(21, "Relic Thief: 2", progression, HELL, Torment, 1) },
            { 22, new ItemData(22, "Relic Thief: 3", progression, HELL, Torment, 1) },

            { 23, new ItemData(23, "Progressive Giantslayer", progression, HELL, Torment, 3) },
            { 24, new ItemData(24, "Giantslayer: 1", progression, HELL, Torment, 1) },
            { 25, new ItemData(25, "Giantslayer: 2", progression, HELL, Torment, 1) },
            { 26, new ItemData(26, "Giantslayer: 3", progression, HELL, Torment, 1) },

            { 27, new ItemData(27, "Progressive Death's Edge", progression, HELL, Torment, 3) },
            { 28, new ItemData(28, "Death's Edge: 1", progression, HELL, Torment, 1) },
            { 29, new ItemData(29, "Death's Edge: 2", progression, HELL, Torment, 1) },
            { 30, new ItemData(30, "Death's Edge: 3", progression, HELL, Torment, 1) },

            { 31, new ItemData(31, "Progressive Ultimate Mastery", progression, HELL, Torment, 3) },
            { 32, new ItemData(32, "Ultimate Mastery: 1", progression, HELL, Torment, 1) },
            { 33, new ItemData(33, "Ultimate Mastery: 2", progression, HELL, Torment, 1) },
            { 34, new ItemData(34, "Ultimate Mastery: 3", progression, HELL, Torment, 1) },

            { 35, new ItemData(35, "Progressive Slaughter Mastery", progression, HELL, Torment, 3) },
            { 36, new ItemData(36, "Slaughter Mastery: 1", progression, HELL, Torment, 1) },
            { 37, new ItemData(37, "Slaughter Mastery: 2", progression, HELL, Torment, 1) },
            { 38, new ItemData(38, "Slaughter Mastery: 3", progression, HELL, Torment, 1) },
